...
activities = {
    ...
    "Soccer Team": {
        ...
        "max_participants": 22,
        "participants": ["alex@mergington.edu", "luna@mergington.edu"]
    },
    "Track and Field": {
        "description": "Running, jumping, and throwing events training",
        "schedule": "Wednesdays and Saturdays, 5:00 PM - 6:30 PM",
        "max_participants": 25,
        "participants": ["matt@mergington.edu", "isabella@mergington.edu"]
    },
    "Drama Club": {
    ...
    "Debate Team": {
        ...
        "max_participants": 16,
        "participants": ["charlie@mergington.edu", "zara@mergington.edu"]
    },
    "Math Club": {
